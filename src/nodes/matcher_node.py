...
def catalogue_match_node(state: TriageState) -> TriageState:
    ...
    if primary_trade in ["Unknown", "Multi-Trade"]:
        ...
        filtered_templates = [t for t in all_templates if t.get("category") in target_trades]
    ...
    user_prompt = build_matcher_user_prompt(extracted_entities.model_dump(), filtered_templates)
